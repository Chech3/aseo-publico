  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      toast({
        ...
        description: "Ha ocurrido un error al crear el cliente. Inténtalo de nuevo.",
        variant: "destructive",
      })
    } finally {
      setIsCreating(false)
    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-[600px]">
        <DialogHeader>
          ...
          <DialogDescription>Ingresa la información del nuevo cliente para el servicio de aseo.</DialogDescription>
        </DialogHeader>
