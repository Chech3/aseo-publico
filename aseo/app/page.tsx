            ...
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="mx-auto max-w-[700px] text-gray-600 md:text-xl">
                  Registra y administra los pagos del aseo urbano de tu
                  municipio o empresa.
                </p>
              </div>
          ...
          <div className="container px-4 md:px-6">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600">
                Nuestros equipos trabajan constantemente para mantener la ciudad
                limpia
              </p>
            </div>
              ...
              <Card className="border-0 shadow-xl bg-gradient-to-br from-green-50 to-green-100 hover:shadow-2xl transition-all transform hover:-translate-y-1">
                <CardHeader>
                  ...
                  <CardDescription className="text-green-600">
                    Registra los servicios de aseo urbano realizados en tu
                    municipio o empresa.
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <p className="text-green-700">
                    Mantén un registro detallado de los servicios prestados,
                    fechas y ubicaciones con nuestra página web.
                  </p>
                </CardContent>
              </Card>
              <Card className="border-0 shadow-xl bg-gradient-to-br from-blue-50 to-blue-100 hover:shadow-2xl transition-all transform hover:-translate-y-1">
                <CardHeader>
                  ...
                  <CardDescription className="text-blue-600">
                    Organiza y gestiona los pagos correspondientes a los
                    servicios de limpieza.
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <p className="text-blue-700">
                    Visualiza el estado de los pagos y mantén un control
              ...
              <Card className="border-0 shadow-xl bg-gradient-to-br from-yellow-50 to-orange-100 hover:shadow-2xl transition-all transform hover:-translate-y-1">
                ...
                <CardContent>
                  <p className="text-orange-700">
                    Optimiza recursos y mejora la calidad de vida de toda la
                    ciudad usando esta herramienta moderna.
                  </p>
                </CardContent>
              </Card>
            </div>
          ...
          <div className="container px-4 md:px-6">
            <div className="text-center mb-12">
              ...
              <p className="text-gray-600 max-w-2xl mx-auto">
                Tu opinión es importante para nosotros. Reporta cualquier
                problema con el servicio de aseo urbano y trabajaremos para
                solucionarlo.
              </p>
            </div>
        ...
        <section className="py-12 md:py-24 lg:py-32 bg-gradient-to-r from-green-100 via-blue-100 to-yellow-100">
          <div className="container px-4 md:px-6">
            <div className="text-center mb-12">
              ...
              <p className="text-gray-600 max-w-2xl mx-auto">
                Nuestro sistema ayuda a optimizar los servicios del aseo urbano,
                contribuyendo a tener una ciudad más limpia y sostenible.
              </p>
            </div>
      ...
      <footer className="border-t bg-white/80 backdrop-blur-sm py-6">
        <div className="container flex flex-col items-center justify-between gap-4 md:flex-row">
          <p className="text-sm text-gray-600">
            © 2025 aseo. Todos los derechos reservados.
          </p>
