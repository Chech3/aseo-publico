              ...
              <Card className="border-0 shadow-xl bg-gradient-to-br from-blue-50 to-blue-100 hover:shadow-2xl transition-all transform hover:-translate-y-1">
                ...
                <CardContent>
                  <p className="text-blue-700">
                    Visualiza el estado de los pagos, genera informes coloridos y mantén un control financiero
                    eficiente.
                  </p>
                </CardContent>
              </Card>
              <Card className="border-0 shadow-xl bg-gradient-to-br from-yellow-50 to-orange-100 hover:shadow-2xl transition-all transform hover:-translate-y-1">
                ...
                <CardContent>
                  <p className="text-orange-700">
                    Optimiza recursos y mejora la calidad de vida de toda la ciudad usando esta herramienta
                    moderna.
                  </p>
                </CardContent>
              </Card>
          ...
          <div className="container px-4 md:px-6">
            <div className="text-center mb-12">
              ...
              <p className="text-gray-600 max-w-2xl mx-auto">
                Nuestro sistema ayuda a optimizar los servicios del aseo urbano, contribuyendo a tener una ciudad más limpia y
                sostenible.
              </p>
            </div>
